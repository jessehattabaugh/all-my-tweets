...
Still I was sad that all the things I had written might be lost. So I found [a tool that could download all my Tweets](https://github.com/pauldotknopf/twitter-dump/). I installed .NET for the first time just to use it. The result is this .json file. Look on my works, ye Mighty, and despair.
